package ai.moonshine.examples.dialogflow;

import ai.moonshine.examples.dialogflow.databinding.ActivityMainBinding;
import ai.moonshine.voice.DialogFlow;
...
public class MainActivity extends AppCompatActivity {
    ...
    /** DialogFlow's blocking calls (load, start, handleUtterance) run here. */
    ...
    private void wifiSetup(DialogFlow.Dialog d) {
        ...
        if ("password".equals(security)) {
            ...
            d.say("Got it, " + DialogFlow.spellOut(password) + ".");
        }
    ...
    private void sendTypedUtterance() {
        ...
        worker.execute(() -> dialog.handleUtterance(text));
    }
