"""Intent recognition via semantic embeddings.

Internal to the binding: :class:`~moonshine_voice.dialog_flow.DialogFlow` is
the supported way to match spoken phrases, and it owns a recognizer on the
application's behalf.  Nothing here is exported from ``moonshine_voice``.
"""
