...
/// Rule-based Turkish G2P (mirrors ``turkish_rule_g2p.py``): nearly phonemic
/// orthography, contextual
/// **ğ**, **k/g** harmony, default final-syllable stress, optional cardinal
/// digit expansion.
...
std::string turkish_word_to_ipa(const std::string& word,
                                bool with_stress = true,
                                bool expand_cardinal_digits = true);

/// Full text; mirrors Python ``text_to_ipa``.
std::string turkish_text_to_ipa(const std::string& text,
                                bool with_stress = true,
