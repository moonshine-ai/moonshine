...
/// Vietnamese lexicon + greedy longest-match + OOV syllable rules (Northern
/// IPA, ``data/vi/dict.tsv``).
class VietnameseRuleG2p : public RuleBasedG2p {
 public:
  ...
  /// One surface token (no spaces); mirrors
  /// :func:`vietnamese_rule_g2p.vietnamese_word_to_ipa`.
