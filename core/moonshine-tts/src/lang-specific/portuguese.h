...
/// Rule- and lexicon-based Portuguese G2P (Brazil / Portugal), mirroring
/// ``portuguese_rule_g2p.py`` and ``portuguese_numbers.py``.
...
/// True for ``pt``, ``pt-PT``, ``pt_pt``, ``portugal``, etc. (European); false
/// for Brazil variants.
...
/// Default lexicon: ``<model-root>/../data/pt_br/dict.tsv`` or
/// ``.../pt_pt/dict.tsv``.
