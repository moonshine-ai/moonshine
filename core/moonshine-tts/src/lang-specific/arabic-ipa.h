...
/// *assimilation_prefix_source_utf8* (when non-empty) is the pre-ONNX word;
/// sun-letter assimilation uses its undiacritized prefix so leading punctuation
/// matches ``arabic_ipa.word_to_ipa_with_assimilation`` (the diacritizer may
/// drop non-Arabic brackets from *filled_diac_utf8*).
