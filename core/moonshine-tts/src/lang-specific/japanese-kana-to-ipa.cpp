...
bool utf8_starts_with_at(const std::string& s, std::size_t off,
...
// Hiragana mora → (onset, nucleus) IPA. Longer keys must precede shorter
// prefixes (generator order).
static const std::vector<
    std::pair<std::string, std::pair<std::string, std::string>>>
    kMoraDesc = {
        {"きゃ", {"k", "ja"}}, {"きゅ", {"k", "jɯ"}}, {"きょ", {"k", "jo"}},
        {"ぎゃ", {"g", "ja"}}, {"ぎゅ", {"g", "jɯ"}}, {"ぎょ", {"g", "jo"}},
        {"しゃ", {"ɕ", "a"}},  {"しゅ", {"ɕ", "ɯ"}},  {"しょ", {"ɕ", "o"}},
        {"じゃ", {"dʑ", "a"}}, {"じゅ", {"dʑ", "ɯ"}}, {"じょ", {"dʑ", "o"}},
        {"ちゃ", {"tɕ", "a"}}, {"ちゅ", {"tɕ", "ɯ"}}, {"ちょ", {"tɕ", "o"}},
        {"にゃ", {"n", "ja"}}, {"にゅ", {"n", "jɯ"}}, {"にょ", {"n", "jo"}},
        {"ひゃ", {"ç", "a"}},  {"ひゅ", {"ç", "ɯ"}},  {"ひょ", {"ç", "o"}},
        {"びゃ", {"b", "ja"}}, {"びゅ", {"b", "jɯ"}}, {"びょ", {"b", "jo"}},
        {"ぴゃ", {"p", "ja"}}, {"ぴゅ", {"p", "jɯ"}}, {"ぴょ", {"p", "jo"}},
        {"みゃ", {"m", "ja"}}, {"みゅ", {"m", "jɯ"}}, {"みょ", {"m", "jo"}},
        {"りゃ", {"ɾ", "ja"}}, {"りゅ", {"ɾ", "jɯ"}}, {"りょ", {"ɾ", "jo"}},
        {"ふぁ", {"ɸ", "a"}},  {"ふぃ", {"ɸ", "i"}},  {"ふぇ", {"ɸ", "e"}},
        {"ふぉ", {"ɸ", "o"}},  {"ふゃ", {"ɸ", "ja"}}, {"ふゅ", {"ɸ", "jɯ"}},
        {"ふょ", {"ɸ", "jo"}}, {"ヴぁ", {"v", "a"}},  {"ヴぃ", {"v", "i"}},
        {"ヴぇ", {"v", "e"}},  {"ヴぉ", {"v", "o"}},  {"ヴゃ", {"v", "ja"}},
        {"ヴゅ", {"v", "jɯ"}}, {"ヴょ", {"v", "jo"}}, {"てぃ", {"t", "i"}},
        {"てゅ", {"t", "jɯ"}}, {"でぃ", {"d", "i"}},  {"でゅ", {"d", "jɯ"}},
        {"とぅ", {"t", "ɯ"}},  {"どぅ", {"d", "ɯ"}},  {"つぁ", {"ts", "a"}},
        {"つぃ", {"ts", "i"}}, {"つぇ", {"ts", "e"}}, {"つぉ", {"ts", "o"}},
        {"うぃ", {"ɰ", "i"}},  {"うぇ", {"ɰ", "e"}},  {"うぉ", {"ɰ", "o"}},
        {"あ", {"", "a"}},     {"い", {"", "i"}},     {"う", {"", "ɯ"}},
        {"え", {"", "e"}},     {"お", {"", "o"}},     {"か", {"k", "a"}},
        {"き", {"k", "i"}},    {"く", {"k", "ɯ"}},    {"け", {"k", "e"}},
        {"こ", {"k", "o"}},    {"が", {"g", "a"}},    {"ぎ", {"g", "i"}},
...
std::optional<std::tuple<std::string, std::string, std::size_t>> next_mora_key(
    const std::string& s, std::size_t off) {
...
std::string geminate_onset(const std::string& onset,
...
std::string katakana_hiragana_to_ipa(std::string_view sv) {
  ...
  while (i < s.size()) {
    ...
    if (utf8_starts_with_at(s, i, kSmallTsuH) ||
        utf8_starts_with_at(s, i, kSmallTsuK)) {
