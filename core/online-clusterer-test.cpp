...
TEST_CASE("online-clusterer") {
    SUBCASE("embed_and_cluster") {
        ...
        const uint64_t first_cluster_id = clusterer.embed_and_cluster({1.0f, 2.0f, 3.0f});
        const uint64_t second_cluster_id = clusterer.embed_and_cluster({0.0f, -1.0f, -2.0f});
        const uint64_t third_cluster_id = clusterer.embed_and_cluster({2.0f, 4.0f, 6.0f});
        const uint64_t fourth_cluster_id = clusterer.embed_and_cluster({1.0f, -1.0f, 0.0f});
