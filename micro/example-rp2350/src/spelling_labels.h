...
// "double u" (not "dublu"), X is "ex" (not "eks"). A is "hay" (/heɪ/): there is
// no zero-onset English word for the letter-A vowel, and "ay"/"a" come out as
...
inline const char* SpokenForLabel(const char* label) {
  ...
  static constexpr const char* kLetterSpoken[26] = {
      ...
      "ess", "tee", "you", "vee", "double u", "ex",  "why", "zee"};
