...
#   Terminal A:  cpp-tiny/example-rp2350/scripts/monitor.sh  # leave running
#   Terminal B:  cpp-tiny/example-rp2350/scripts/flash.sh    # flash whenever
#
...
#
# Usage:
#   cpp-tiny/example-rp2350/scripts/monitor.sh   # auto-detect /dev/cu.usbmodem*
#   cpp-tiny/example-rp2350/scripts/monitor.sh /dev/cu.usbmodem1101
#   LOG=/tmp/my.log cpp-tiny/example-rp2350/scripts/monitor.sh  # custom log
#   LOG= cpp-tiny/example-rp2350/scripts/monitor.sh             # no logfile
#
